<div class="box">
                ...
                <div class="left-position">
                    <img src="/login/assets/teacher.png" alt="Teacher Image"/>
                </div>
                
                <div class="right-position">
                <?php if (!empty(session()->getFlashData('fail'))) 
                echo "<div class='coverInput' style='padding:5px;' >". session()->getFlashData('fail') . " </div>" ;?>
                    <form action="/cod/public/Signin/teacher" method="post">
                        ...
                        <p>No account yet?<a href="/cod/public/Signin/t_register">Register Here</a></p>
